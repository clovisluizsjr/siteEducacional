...
class AlunoModel {
  ...
  get aluno_responsavel() { return this.#aluno_responsavel } set aluno_responsavel(value) { this.#aluno_responsavel = value }
  ...
  constructor(aluno_RA, aluno_nome, aluno_CPF, aluno_nasc, aluno_fone, aluno_email, aluno_responsavel, aluno_respCPF, aluno_endereco, aluno_senha) {
